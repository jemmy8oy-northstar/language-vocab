...
```
Balenthiran.LanguageVocab.Services/
├── Reporting/
...
Each service has a corresponding interface in `Balenthiran.LanguageVocab.Abstractions/Services/` following the same folder grouping.
